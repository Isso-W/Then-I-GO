...
import { Bell, Settings, Trophy, HelpCircle, Star, ChevronRight, Medal, TreePine, Moon, Briefcase, Coffee, Share2, Mail } from "lucide-react";
    ...
    <AppLayout>
      ...
      <main className="absolute inset-x-5 top-[100px] bottom-[104px] overflow-y-auto no-scrollbar pb-6">
        ...
        <div className="mt-6 space-y-3">
          <MenuRow icon={<Mail size={20} />} label="系统消息" count={2} />
...
function MenuRow({ icon, label, count }: { icon: React.ReactNode; label: string; count?: number }) {
  return (
    <div className="flex items-center justify-between p-4 rounded-2xl bg-white/[0.03] hover:bg-white/[0.06] transition-colors cursor-pointer group">
